function segDiff = polygon(img1, anchor1, img2, anchor2, opts)
...
mask = poly2mask(anchor1([1,5,6],2),anchor1([1,5,6],1),size(img1,1),size(img1,2));
figure
subplot(1,2,1),imshow(img1);
hold on;
plot(anchor1([1,5,6],1),anchor1([1,5,6],2),'r+');
